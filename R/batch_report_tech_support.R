...
#'   batch_all_production_tech_support(facility_spreadsheeet="Facilities Spreadsheet_New.xlsx", 
#'   username="bzhang02", password=key_get("essence"), table="KS_PR_Processed", mft="KS_MFT",  
#'   start="2020-05-01 00:00:00", end="2020-05-30 23:59:59", directory="~", 
#'   email =TRUE,sender="bo.zhang@@kdhe.ks.gov", email_password=key_get("email"), 
